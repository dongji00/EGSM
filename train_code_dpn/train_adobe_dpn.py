...
from train_code_dpn.data_loader import AdobeDataAffineHR
from train_code_dpn.functions import *
from train_code_dpn.networks import ResnetConditionHR, conv_init
from train_code_dpn.loss_functions import alpha_loss, compose_loss, alpha_gradient_loss
...
for epoch in range(0,args.epoch):
	...
	for i,data in enumerate(train_loader):
		#Initiating
		write_step = open("write_step_train_adobe_dpn.txt", 'a')
