...
#CUDA
#-n train_adobe_color -bs 1 -res 512
...
#Original Data
traindata =  AdobeDataAffineHR(csv_file='data_adobe_preprocessing/all.csv',data_config=data_config_train,transform=None)  #Write a dataloader function that can read the database provided by .csv file
...
net.load_state_dict(torch.load(model_dir + '/net_epoch_58_0.2963.pth'))
...
optimizer.load_state_dict(torch.load(model_dir + '/optim_epoch_58_0.2963.pth'))
...
for epoch in range(0,args.epoch):
	...
	for i,data in enumerate(train_loader):
		#Initiating
		write_step = open("write_step_real_train.txt", 'a')
