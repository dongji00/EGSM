...
#CUDA
#-n train_adobe_denoise -bs 4 -res 256
...
#Original Data
traindata =  AdobeDataAffineHR(csv_file='data_adobe/train_adobe.csv',data_config=data_config_train,transform=None)  #Write a dataloader function that can read the database provided by .csv file
...
#net.load_state_dict(torch.load(model_dir + '/net_epoch_33_0.1852.pth')) #uncomment this if you are initializing your model
net.cuda()
...
#optimizer.load_state_dict(torch.load(model_dir + '/optim_epoch_33_0.1852.pth')) #uncomment this if you are initializing your model
...
for epoch in range(0,args.epoch):
	...
	for i,data in enumerate(train_loader):
		#Initiating
		write_step = open("write_step_train_adobe_60.txt", 'a')
