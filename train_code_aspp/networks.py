...
import numpy as np
from train_code_aspp.ASPP_1 import ASPP_module
#from torchvision.models.segmentation.deeplabv3 import ASPP
from train_code_aspp.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
from train_code_aspp.utils import BatchNorm, BatchNormGroup
from train_code_aspp.utils import load_matched_state_dict, ResNetEncoder
...
class ResnetConditionHR(nn.Module):
	def __init__(self, input_nc, output_nc, ngf=64, nf_part=64,norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks1=7, n_blocks2=3, padding_type='reflect'):
		...
		'''model_dec_coarse_matte = [nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),
	...
	def forward(self, image,back,seg,multi):
		...
		#back_feat = self.aspp(back_feat)
		seg_feat=self.model_enc_seg(seg)
		#seg_feat = self.aspp2(seg_feat)
		multi_feat=self.model_enc_multi(multi)
		#multi_feat = self.aspp2(multi_feat)
