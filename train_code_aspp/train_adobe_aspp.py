...
from train_code_aspp.data_loader import AdobeDataAffineHR
from train_code_aspp.functions import *
from train_code_aspp.networks import ResnetConditionHR, conv_init
from train_code_aspp.loss_functions import alpha_loss, compose_loss, alpha_gradient_loss
from torchsummary import summary

#CUDA
# -n train_aspp -bs 2 -res 256
...
#Original Data
traindata =  AdobeDataAffineHR(csv_file='data_adobe_aspp/train_data_aspp.csv',data_config=data_config_train,transform=None)  #Write a dataloader function that can read the database provided by .csv file
...
# net.load_pretrained_deeplabv3_state_dict(torch.load("D:\keke\matting\mine-matting_0823\\train_code_aspp\\resnet50-19c8e357.pth")['model_state'])
...
for epoch in range(0,args.epoch):
	...
	for i,data in enumerate(train_loader):
		#Initiating
		write_step = open("write_step_train_aspp.txt", 'a')
