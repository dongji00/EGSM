...
from train_code_norm.data_loader import AdobeDataAffineHR
from train_code_norm.functions import *
from train_code_norm.networks import ResnetConditionHR, conv_init
from train_code_norm.loss_functions import alpha_loss, compose_loss, alpha_gradient_loss
from torchsummary import summary

#CUDA
#-n train_adobe -bs 1 -res 512
...
#Original Data
traindata =  AdobeDataAffineHR(csv_file='data_adobe/train_data_norm.csv',data_config=data_config_train,transform=None)  #Write a dataloader function that can read the database provided by .csv file
...
for epoch in range(0,args.epoch):
	...
	for i,data in enumerate(train_loader):
		#Initiating
		write_step = open("write_step_train_adobe_norm.txt", 'a')
